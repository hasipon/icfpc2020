...
var trlog_TrlogReader = function(reader) {
	...
	haxe_Log.trace(this._frameSize,{ fileName : "../lib/trlog/TrlogReader.hx", lineNumber : 40, className : "trlog.TrlogReader", methodName : "new", customParams : [this._entrySize,Std.string(_$UInt_UInt_$Impl_$.toFloat(this._byteSize)),headerSize]});
};
	...
	getText: function(frame) {
		...
		while(_g < _g1.length) {
			...
			while(_g2 < _g11) {
				...
				haxe_Log.trace(entry.commandPosition,{ fileName : "../lib/trlog/TrlogReader.hx", lineNumber : 59, className : "trlog.TrlogReader", methodName : "getText"});
				haxe_Log.trace(entry.byteSize,{ fileName : "../lib/trlog/TrlogReader.hx", lineNumber : 60, className : "trlog.TrlogReader", methodName : "getText"});
				while(this.position < target) {
					var byte = this.readByte();
					haxe_Log.trace(byte,{ fileName : "../lib/trlog/TrlogReader.hx", lineNumber : 64, className : "trlog.TrlogReader", methodName : "getText"});
					if(byte == 0) {
						var string = this.readLongString();
						haxe_Log.trace(string,{ fileName : "../lib/trlog/TrlogReader.hx", lineNumber : 69, className : "trlog.TrlogReader", methodName : "getText"});
						stringBuf_b += string == null ? "null" : "" + string;
					} else {
						var command = byte;
						haxe_Log.trace(command,{ fileName : "../lib/trlog/TrlogReader.hx", lineNumber : 73, className : "trlog.TrlogReader", methodName : "getText"});
